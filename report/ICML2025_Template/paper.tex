...
Figure~\ref{fig:training-curve} shows the full training and validation
accuracy curves over 80 epochs.  Both metrics converge to near-perfect
values by epoch 55.

\begin{table}[t]
\caption{Training and validation accuracy over epochs.}
\label{tab:training-curve}
\vskip 0.15in
\begin{center}
\begin{small}
\begin{sc}
